...
import com.polycom.uvccamera.usb.Size;
...
public final class CameraServer extends Handler {
	...
	public static CameraServer createServer(final Context context, final USBMonitor.UsbControlBlock ctrlBlock, final int vid, final int pid) {
...
//				if (DEBUG) Log.d(TAG_THREAD, "onFrameAvailable:");
		...
		private void loadShutterSound(final Context context) {
		    ...
		    mSoundId = mSoundPool.load(context, com.polycom.usbcameratest4.R.raw.camera_click, 1);
		}
