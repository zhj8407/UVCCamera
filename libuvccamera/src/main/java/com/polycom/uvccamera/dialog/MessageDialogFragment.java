package com.polycom.uvccamera.dialog;
...
public class MessageDialogFragment extends DialogFragment {
    ...
    public static MessageDialogFragment showDialog(final Activity parent, final int requestCode,
            final int id_title, final int id_message, final String[] permissions) {
        final MessageDialogFragment dialog = newInstance(requestCode, id_title, id_message,
                permissions);
    ...
    public static MessageDialogFragment newInstance(final int requestCode, final int id_title,
            final int id_message, final String[] permissions) {
    ...
    public void onAttach(final Activity activity) {
        ...
        if (mDialogListener == null) {
//			Log.w(TAG, "caller activity/fragment must implement
// PermissionDetailDialogFragmentListener");
                            ...
                            public void onClick(final DialogInterface dialog,
                                ...
                                try {
                                    mDialogListener.onMessageDialogResult(
                                            MessageDialogFragment.this, requestCode, permissions,
                                            true);
