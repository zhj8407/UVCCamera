...
/**
 * This class receives video images as ByteBuffer(strongly recommend direct ByteBuffer) as
 * NV21(YUV420SP)
 * and encode them to h.264.
 * If you use this directly with IFrameCallback, you should know UVCCamera and it backend native
 * libraries
 * never execute color space conversion. This means that color tone of resulted movie will be
 * different
...
public class MediaVideoBufferEncoder extends MediaEncoder implements IVideoEncoder {
    ...
    public MediaVideoBufferEncoder(final MediaMuxerWrapper muxer, final int width, final int height,
